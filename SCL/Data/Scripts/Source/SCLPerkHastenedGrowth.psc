ScriptName SCLPerkHastenedGrowth Extends SCLPerkBase
...
Bool Function canTake(Actor akTarget, Int aiPerkLevel, Bool abOverride, Int aiTargetData = 0)
  ...
  Int ExpandNum = JMap.getInt(TargetData, "SCLExpandNum")
...
Bool Function takePerk(Actor akTarget, Bool abOverride = False, Int aiTargetData = 0)
  ...
  If canTake(akTarget, i, abOverride)
    ...
    ElseIf i == 3
      AddAmount = 0.5
    EndIf
    JMap.setFlt(TargetData, "SCLExpandBonusMulti", JMap.getFlt(TargetData, "SCLExpandBonusMulti", 1) + AddAmount)
